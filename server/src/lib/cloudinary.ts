...
const uploadPreset = process.env.CLOUDINARY_UPLOAD_PRESET ?? "diq0wn1bm";
...
/// Returns a signed Cloudinary URL for downloading a file by public id.
...
export async function uploadPdfToCloudinary(
  ...
  form.append("folder", "gyanbookllm/pdfs");
