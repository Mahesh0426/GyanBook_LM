...
// Step 1 of the pipeline: extract text from source content (PDF, video transcript, etc.)
...
// Step 2 of the pipeline: chunk source text into smaller pieces for embedding and indexing
